...
/obj/item/modular_computer/proc/alert_call(datum/computer_file/program/alerting_program, alerttext, sound = 'sound/machines/twobeep_high.ogg')
	...
	visible_message("<span class='notice'>The [src] displays a [alerting_program.filedesc] notification: [alerttext]</span>")
	var/mob/living/holder = loc
	if(istype(holder))
		to_chat(holder, "[icon2html(src)] <span class='notice'>The [src] displays a [alerting_program.filedesc] notification: [alerttext]</span>")
