/obj/machinery/astrometrics_dish
	name = "\improper Astrometrics scanning dish"
	desc = "A large dish used to collect general astrometrics data."
...
/obj/machinery/astrometrics_dish/neutrino
	name = "neutrino detection chamber"
